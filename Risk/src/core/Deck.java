...
public class Deck {
	...
	private static void PupulateCountries() {
		for(int i=0;i<42;i++){
			Player p = null;
			countriesBeforeShuffle[i] = new Country(Data.COUNTRY_NAMES[i], p, 10, Data.getCountryCoord()[i][0], Data.getCountryCoord()[i][1], Data.ADJACENT[i], Data.CONTINENT_IDS[i], "Abb",i );
	...
	private static void Reassign(String result) {
		...
		for (int i = 0;i<42;i++){
			if(result.compareTo(countriesBeforeShuffle[i].getName()) == 0){
				...
				case 38:
				case 40:
					Player p = new Player (CommandInput.getPlayer1(), CommandInput.player1Colour,0,0);
				...
				case 39:
				case 41:
					p = new Player (CommandInput.getPlayer2(), CommandInput.player2Colour,0,0);
					countriesAfterShuffle[z] = new Country( countriesBeforeShuffle[i]);
					countriesAfterShuffle[z].setOccupyingPlayer(p);
					if(u==1){
				...
				case 26:
				case 32:
					p = new Player("Neutral 1", Color.BLACK,0,0);
					countriesAfterShuffle[z] = new Country( countriesBeforeShuffle[i]);
					countriesAfterShuffle[z].setOccupyingPlayer(p);
					z++;
					break;
				...
				case 27:
				case 33:
					p = new Player("Neutral 2", Color.GREEN, 0, 0);
					countriesAfterShuffle[z] = new Country( countriesBeforeShuffle[i]);
					countriesAfterShuffle[z].setOccupyingPlayer(p);
					z++;
					break;
				...
				case 28:
				case 34:
					p = new Player("Neutral 3", Color.RED, 0, 0);
					countriesAfterShuffle[z] = new Country( countriesBeforeShuffle[i]);
					countriesAfterShuffle[z].setOccupyingPlayer(p);
					z++;
					break;
				...
				case 29:
				case 35:
					p = new Player("Neutral 4", Color.YELLOW,0,0);
					countriesAfterShuffle[z] = new Country( countriesBeforeShuffle[i]);
					countriesAfterShuffle[z].setOccupyingPlayer(p);
					z++;
					break;
